...
const PERSPECTIVES = [
  {
    ...
    color: "#e8c547",
    detail:
      "Each one is a chance to swim, travel, or sit in the sun with someone you love.",
  },
  {
    key: "sunrisesLeft",
    icon: "🌅",
  ...
  },
  {
    ...
    color: "#e8c547",
    detail:
      "Each one is not just a celebration — it's a milestone of finite time.",
  },
];
...
function calculatePerspectivesFromFigure(figure) {
  ...
  const yearsRemaining = Math.max(
    0,
    assumedLifespan - (progress.ageYears || 0),
  );
  ...
  return (
    <motion.div
      ...
      <div className="persp-card-inner">
        ...
        <div className="persp-value" style={{ color: perspective.color }}>
